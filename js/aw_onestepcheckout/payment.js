AWOnestepcheckoutPayment = Class.create();
AWOnestepcheckoutPayment.prototype = {
    ...
    showAdditionalInfo: function(methodCode) {
        ...
        [block + '_before', block, block + '_after'].each(function(el) {
            ...
            if (element) {
                ...
                var newHeight = AWOnestepcheckoutCore.getElementHeight(element);
    ...
    savePayment: function() {
        ...
        AWOnestepcheckoutCore.updater.startRequest(this.savePaymentUrl, {
            method: 'post',
