AWOnestepcheckoutAddress = Class.create();
AWOnestepcheckoutAddress.prototype = {
    ...
    onAddressChanged: function(e) {
        ...
        AWOnestepcheckoutCore.updater.startRequest(this.addressChangedUrl, requestOptions);
    },
    ...
    onBillingCountrySelectChanged: function(e) {
    ...
    onShippingCountrySelectChanged: function(e) {
    ...
    showShippingAddressContainer: function() {
        ...
        var newHeight = AWOnestepcheckoutCore.getElementHeight(this.shipping.container);
    ...
    showPasswordContainer: function() {
        ...
        var newHeight = AWOnestepcheckoutCore.getElementHeight(this.billing.passwordContainer);
    ...
    showNewAddressContainer: function(container) {
        ...
        var newHeight = AWOnestepcheckoutCore.getElementHeight(container);
